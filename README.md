...
## Environments
- Preview: https://main--sausaxen-itc-foodiesonly--aemysites.aem.page/
- Live: https://main--sausaxen-itc-foodiesonly--aemysites.aem.live/
...
1. Open the `sausaxen-itc-foodiesonly` directory in your favorite IDE and start coding :)
